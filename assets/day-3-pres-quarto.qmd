...
::: {.fragment .fade-in}
```{=html}
<iframe width=100% height=575 src="basic-html.html" style="border: 1px solid #323C46; max-height: unset; max-width: unset; box-shadow: 0 0 2rem 0 rgba(0, 0, 0, .5); border-radius: 5px;"></iframe>
```
:::
...
The header can also be used to [define re-usable parameters](https://posit.co/blog/parameterized-quarto/){preview-link="true"}, and these can be used in the body of the report.
